Pod::Spec.new do |s|
    ...
    s.source_files = tags + '/ISUnityAdsAdapter.framework/Versions/A/Headers/*.h'

    s.public_header_files = tags + '/ISUnityAdsAdapter.framework/Versions/A/Headers/*.h'


    s.vendored_frameworks = tags + '/ISUnityAdsAdapter.framework'
